...
@Component({
  selector: 'app-freelance-offres',
  templateUrl: './freelance-offres.component.html',
  styleUrls: ['./freelance-offres.component.css']
})
export class FreelanceOffresComponent {
  counter:any
  ...
  constructor(private sprservice:SuperadminService, private  frlcservice: FreelancerService,private route:Router, private toastr: ToastrService,private supservice: SuperadminService) {
    ...
    async ngOnInit(): Promise<void> {
      ...
      try {
        const data = await this.frlcservice.getalloffres().toPromise();
