...
@Component({
  ...
  styleUrls: ['./freelancer-training.component.css']
})
export class FreelancerTrainingComponent {
  ...
  constructor(private empservice:FreelancerService,private route:Router, private toastr: ToastrService) {
...
console.log(this.userdata)
  ...
  getdata(diplome: string, description: string,date_debut: Date,date_fin: Date, ecole: string, id: any) {
